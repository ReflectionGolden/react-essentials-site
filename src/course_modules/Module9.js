    ...
    return (
        <div>
            ...
            <div className='Component-Container'>
                ...
                <p>
                    The Movie Review App has been created as a separate project at my <a className='App-link' href="" target='_blank'>movie-review-project</a><a className='App-link' href="" target="_blank"><FontAwesomeIcon icon={faGithub}/></a> based on the lessons and practical activities provided within module 9 of the ITOL React Essentials course.
                </p>
            </div>
        </div>
    );
